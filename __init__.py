...
# tap_plugin.project_management_core (see tap_plugin/project_management_core/). This file exists only so pytest names this
...
# wheel (only tap_plugin/project_management_core/ is packaged). Deliberately empty otherwise.
